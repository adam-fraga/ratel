...
var createProjectCmd = &cobra.Command{
	...
	Long:        "Create and initialize structure for a new project with the framework, take the project name as argument.",
	Annotations: map[string]string{"category": "project"},
	Run: func(cmd *cobra.Command, args []string) {
		if len(args) == 1 {
			project.InitProject(args[0])
		} else {
			if err := ut.RunCommandWithOutput("./ratel", "project --help"); err != nil {
